...
class ReactorEcomEnv(Env):
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        self.original_conc_temp = yout[5]
    ...
    def step(self, action: np.ndarray):
        ...
        ns, terminal, p_penalty = DymolaDyn(self, s_augmented)
        ...
        if not terminated:
            ...
            print(10000*(ns[5]-self.original_conc_temp))
            reward = (reward_price/1e8)*average_power - 5*steps*abs(ns[5]-self.original_conc_temp)
    ...
    def _get_ob(self):
        ...
        #self.variables = ["Time","BOP.sensorW.W","PowerDemand.y","DNI_Input.y[1]","CosEff_Input.y[1]", "BOP.deaerator.medium.p","dual_Pipe_CTES_Controlled_Feedwater.CTES.T_Ave_Conc","BOP.sensor_T2.T","SMR_Taveprogram.core.Q_total.y" ]
        return np.array(
            [(s[0]-53.35e6)/1e7, (s[1]-53.35e6)/1e7, (s[2]-500)/1000, s[3]-0.5, (s[4]-202000)/202000, (s[5]-423)/100, (s[6]-373)/100, (s[7]-1.58E8)/1E8, s[8]/10000, s[9]/10000, s[10]/10000], dtype=np.float32
        )
...
def DymolaDyn(self, y0):
    ...
    return yout, terminal, p_penalty
