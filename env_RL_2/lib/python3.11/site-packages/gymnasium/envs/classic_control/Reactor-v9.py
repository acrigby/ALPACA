...
class ReactorEnv(Env):
    ...
    os.mkdir(str(ALPACApath) + '/HPC_runs/Output/ThreadFiles/' + str(tid))
    
    #Initialise the model and create first dsfinal file
    os.system('cp -a /home/rigbac/Projects/ALPACA/HPC_runs/DymolaTemplates/. /home/rigbac/Projects/ALPACA/HPC_runs/Output/ThreadFiles/' + str(tid))
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        os.chdir('/home/rigbac/Projects/ALPACA/HPC_runs/Output/ThreadFiles/' + str(tid))
        ...
        times,prices = importdict('/home/rigbac/Projects/ALPACA/HPC_runs/Input/20240522-20240528 CAISO Day-Ahead Price','SCE',0) #start the function with the name of the file
        #print(list(self.n))
        #print(self.y)
