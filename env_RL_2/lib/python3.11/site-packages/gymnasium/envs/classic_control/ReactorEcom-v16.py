...
class ReactorEcomEnv(Env):
    ...
    def __init__(self, render_mode: Optional[str] = None):
        ...
        os.system('cp -a -f /home/rigbac/Projects/ALPACA/HPC_runs/DSFinalStore6/. /scratch/rigbac/ThreadFilesFWHPT/' + str(tid))
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        if options is not None:
            start_offset = options['month']*720+ options['period']*120 + 1
