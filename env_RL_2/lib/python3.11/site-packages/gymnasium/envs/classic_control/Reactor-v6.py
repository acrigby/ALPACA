...
class ReactorEnv(Env):
    ...
    os.mkdir(str(ALPACApath) + '/DymolaRunDataSAC' + str(tid))
    wd = 'Modelica.Utilities.System.setWorkDirectory("' + str(ALPACApath) + '/DymolaRunDataSAC' + str(tid) + '")'
    print(wd)
    ...
    def __init__(self, render_mode: Optional[str] = None):
        ...
        self.dt = 5
        high = np.array(
            [15, 15, 15, 10], dtype=np.float32
        )
        low = np.array(
            [-15, -15, 0, -10], dtype=np.float32
        )
...
def DymolaDyn(self,model ,y0 , t,  variables, results, dymola,fflist):
    ...
    trajsize = dymola.readTrajectorySize(str(self.ALPACApath)+"/DymolaRunDataSAC" + str(tid) + "/SteamTurbine_L2_OpenFeedHeat_Test2.mat")
    signals=dymola.readTrajectory(str(self.ALPACApath)+"/DymolaRunDataSAC" + str(tid) + "/SteamTurbine_L2_OpenFeedHeat_Test2.mat", variables, trajsize)
