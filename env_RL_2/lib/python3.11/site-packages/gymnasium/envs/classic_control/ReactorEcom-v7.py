...
from PriceReader import importdict, importDNI, importdict3, importdict4
...
class ReactorEcomEnv(Env):
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        self.price_schedule,self.prices, self.DNIs, self.IAMs = importdict4('/home/rigbac/Projects/ALPACA/HPC_runs/Input/TestSyn',price_offset,price_year) #start the function with the name of the file
