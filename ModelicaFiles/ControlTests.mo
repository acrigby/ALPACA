...
package ControlTests
  ...
  model SteamTurbine_L2_OpenFeedHeat_Test
    ...
    NHES.Fluid.Sensors.stateDisplay stateDisplay
      annotation (Placement(transformation(extent={{-132,-44},{-66,-16}})));
    NHES.Fluid.Sensors.stateDisplay stateDisplay1
      annotation (Placement(transformation(extent={{-118,26},{-44,58}})));
  ...
  equation
    ...
    connect(stateDisplay1.statePort, stateSensor1.statePort) annotation (Line(
          points={{-81,37.84},{-81,22},{-40,22},{-40,26},{-27.95,26},{-27.95,
            12.05}},                                                 color={0,0,0}));
    connect(stateDisplay.statePort, stateSensor.statePort) annotation (Line(
          points={{-99,-33.64},{-99,-48},{-60,-48},{-60,-14},{-72,-14},{-72,14},
            {-46,14},{-46,0},{-44.05,0},{-44.05,-13.95}},    color={0,0,0}));
...
<p>This model was designed by Aidan Rigby (<a href=\"mailto:aidan.rigby@inl.gov\">aidan.rigby@inl.gov</a> , <a href=\"mailto:acrigby@wisc.edu\">acrigby@wisc.edu</a> ). All initial questions should be directed to Daniel Mikkelson (<a href=\"mailto:Daniel.Mikkelson@inl.gov\">Daniel.Mikkelson@inl.gov</a>). </p>
  ...
  model SteamTurbine_L2_OpenFeedHeat_Test3
    ...
    Modelica.Blocks.Sources.CombiTimeTable
                                      FeedForward(
      tableOnFile=false,
      table=[0,0; 9900,0; 9905,0; 9910,0; 9915,0; 9920,0; 9925,0; 9930,0; 9935,
          0; 9940,0; 9945,0; 9950,0; 9955,0; 9960,0; 9965,0; 9970,0; 9975,0;
          9980,0; 9985,0; 9990,0; 9995,0; 10000,0.066666667; 10005,0.366666667;
          10010,0.649999987; 10015,0.8333333; 10020,0.716666617; 10025,
          0.649999963; 10030,0.549999983; 10035,0.55; 10040,0.48333334; 10045,
          0.450000013; 10050,0.400000027; 10055,0.350000033; 10060,0.333333373;
          10065,0.26666671; 10070,0.23333338; 10075,0.183333383; 10080,
          0.15000005; 10085,0.133333383; 10090,0.066666717; 10095,-0.049999953;
          10100,-0.249999957; 10105,-0.316666627; 10110,-0.34999996; 10115,-0.316666627;
          10120,-0.416666623; 10125,-0.416666623; 10130,-0.416666623; 10135,-0.416666623;
          10140,-0.416666623; 10145,-0.483333287; 10150,-0.416666623; 10155,-0.483333287;
          10160,-0.416666623; 10165,-0.483333287; 10170,-0.449999957; 10175,-0.49999996;
          10180,-0.4833333; 10185,-0.49999997; 10190,-0.46666664; 10195,-0.46666664;
          10200,-0.46666664; 10205,-0.49999997; 10210,-0.49999997; 10215,-0.49999997;
          10220,-0.49999997; 10225,-0.49999997; 10230,-0.49999997; 10235,-0.49999997;
          10240,-0.49999997; 10245,-0.49999997; 10250,-0.49999997; 10255,-0.49999997;
          10260,-0.49999997; 10265,-0.49999997; 10270,-0.49999997; 10275,-0.49999997;
          10280,-0.49999997; 10285,-0.51666663; 10290,-0.49999996; 10295,-0.49999996;
          10300,-0.49999996; 10305,-0.466666627; 10310,-0.449999957; 10315,-0.449999957;
          10320,-0.51666662; 10325,-0.51666662; 10330,-0.48333329; 10335,-0.48333329;
          10340,-0.49999995; 10345,-0.49999994; 10350,-0.48333327; 10355,-0.48333327;
          10360,-0.49999994; 10365,-0.49999994; 10370,-0.49999994; 10375,-0.49999994;
          10380,-0.49999994; 10385,-0.49999994; 10390,-0.49999994; 10395,-0.49999994;
          10400,-0.49999996; 20000,-0.5],
      tableName="data",
  ...
  "
    ...
    input String varOrigNames[:]={"Time","BOP.sensorW.y","ramp.y","pump_SimpleMassFlow1.m_flow","sensor_pT.T","BOP.deaerator.level", "FeedForward.y[1]"} "Variable names/headers in the file in modelica syntax";
      input String varReNames[:]={"Time","Power", "DemandedPower","PumpMFlow","SGOutTemp","DLevel", "FF"} "Variable names which will appear in the MAT results file";
    ...
    protected
       ...
       Integer noColumn=6 "Number of columns in the trajectory being converted";
