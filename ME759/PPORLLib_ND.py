...
Orig_results = matreader(str(ALPACApath)+"/RunData/Original_Temp_Profile.mat", Orig_variables)
...
plt.savefig(f"/home/rigbac/Projects/ALPACA/Figures/PPOHPC_ND/original.png")
plt.close()
...
algo = (
    ...
    .training(train_batch_size=(256),lr=0.00001)
    .resources(num_cpus_per_worker=1,num_gpus=1)
    .environment(env= "Reactor-v5")
    .build()
)

#algo = Algorithm.from_checkpoint("C:/Users/aidan/projects/ALPACA/RunData/TrainedSAC/04032024-SAC")
...
for i in range(3000):
    ...
    if i % 5 == 0:
        ...
        plt.savefig(f"/home/rigbac/Projects/ALPACA/Figures/PPOHPC_ND/Iteration_{i}.png")
        plt.close()

        plt.plot(rewards)
        plt.savefig(f"/home/rigbac/Projects/ALPACA/Figures/PPOHPC_ND/Rewards.png")
        plt.close()
        # Print the final score
        print(f"FINAL SCORE: {score} - Temperature: {0}") # Print the final score
    
    if i % 50 == 0:
        checkpoint_dir = algo.save(f"/home/rigbac/Projects/ALPACA/RunData/TrainedPPO_{i}").checkpoint.path
