...
algo = (
    ...
    .training(train_batch_size=(2048),lr_schedule=([0,1e-4],[400000,1e-5],[800000,1e-6]))
    .resources(num_cpus_per_worker=0.5,num_gpus=0)
    .environment(env= "Reactor-v88")
    .build()
)"""

algo = Algorithm.from_checkpoint('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/PPO_Discrete/FinalControlPPO_100')
"""
...
for i in range(100,3000):
    ...
    if i % 25 == 0:
        ...
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/PPO_Discrete/Iteration_{i}.png")
        plt.close()

        plt.plot(rewards)
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/PPO_Discrete/Rewards.png")
        plt.close()
        # Print the final score
        print(f"FINAL SCORE: {score} - Temperature: {0}") # Print the final score
    
    if i % 50 == 0:
        checkpoint_dir = algo.save(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/PPO_Discrete/FinalControlPPO_{i}").checkpoint.path
