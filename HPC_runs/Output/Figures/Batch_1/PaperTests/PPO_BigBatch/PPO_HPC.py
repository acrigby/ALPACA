...
algo = (
    ...
    .training(train_batch_size=(10000),lr_schedule=([0,1e-4],[400000,1e-5],[800000,1e-6]))
...
for i in range(3000):
    ...
    if i % 5 == 0:
        ...
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/PPO_BigBatch/Iteration_{i}.png")
        plt.close()

        plt.plot(rewards)
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/PPO_BigBatch/Rewards.png")
        plt.close()
        # Print the final score
        print(f"FINAL SCORE: {score} - Temperature: {0}") # Print the final score
    
    if i % 5 == 0:
        checkpoint_dir = algo.save(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/PPO_BigBatch/FinalControlPPO_{i}").checkpoint.path
