...
algo = Algorithm.from_checkpoint("/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/DQN_MoreActions_Long/FinalControlDQN_1450")

rewards = []

for i in range(1450,6000):
    ...
    if i % 5 == 0:
        ...
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/DQN_MoreActions_Long/Iteration_{i}.png")
        plt.close()

        plt.plot(rewards)
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/DQN_MoreActions_Long/Rewards.png")
        plt.close()
        # Print the final score
        print(f"FINAL SCORE: {score} - Temperature: {0}") # Print the final score
    
    if i % 50 == 0:
        checkpoint_dir = algo.save(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperTests/DQN_MoreActions_Long/FinalControlDQN_{i}").checkpoint.path
