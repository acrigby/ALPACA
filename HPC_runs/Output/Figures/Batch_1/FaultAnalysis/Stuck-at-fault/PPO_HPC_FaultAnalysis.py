...
newfolder = '/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FaultAnalysis/Trial1'
...
for i in range(3,6,1):
    ...
    axs[0].axvline(x = 14*5, color = 'r', label = 'Fault')
    axs[0].plot(t1, temps)
    ...
    axs[1].axvline(x = 14*5, color = 'r', label = 'Fault')
    ...
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FaultAnalysis/Trial1/Iteration_{i}.png")
    plt.close()

    plt.plot(rewards)
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FaultAnalysis/Trial1/Rewards.png")
    plt.close()
...
with open('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FaultAnalysis/Trial1/rewards_dict.txt', 'a') as convert_file: 
    convert_file.write(json.dumps(file_dict))
    convert_file.write('\n')
with open('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FaultAnalysis/Trial1/means.txt', 'a') as convert_file: 
...
with open('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FaultAnalysis/Trial1/final_rewards_dict.txt', 'a') as convert_file: 
    convert_file.write(json.dumps(rewards_dict))
with open('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FaultAnalysis/Trial1/final_means.txt', 'a') as convert_file: 
