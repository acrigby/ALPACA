...
def read_csv_and_create_lists(path):
    ...
    file_name = path + 'output_year_SS.csv'
...
if __name__ == "__main__":
    csv_file_path = "/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/SS/"  # Replace with your CSV file path
    ...
    for i, segment in enumerate(lists):
        ...
        try:
            ...
            plt.xlabel('Concrete Temperature / degC')
            plt.ylabel('Power Demand / MW')
            #plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FinalPPO3/Correlation{i}.png")
            plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/SS/Correlation_Temperature.png")
            plt.close()
