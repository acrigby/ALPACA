...
def read_csv_and_create_lists(path, col):

    segment_lists = [[] for _ in range(6)]

    file_name = path + 'SS/output_year_SS.csv'
...
if __name__ == "__main__":
    csv_file_path = "/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/"  # Replace with your CSV file path
    """
    ...
    for i, segment in enumerate(lists):
        ...
        try:
            ...
            #plt.xlabel('Time / hours')
            #plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FinalPPO3/Correlation{i}.png")
            plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/SS/"+var+"_Time_year.png")
            plt.close()
        #plt.plot(segment,lists_y[i-1])
        #plt.show()
        except:
    ...
    for i, segment in enumerate(lists):
        ...
        try:
            ...
            #plt.xlabel('Time / hours')
            #plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FinalPPO3/Correlation{i}.png")
            plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/SS/Test.png")
            plt.close()
        #plt.plot(segment,lists_y[i-1])
        #plt.show()
        except:
