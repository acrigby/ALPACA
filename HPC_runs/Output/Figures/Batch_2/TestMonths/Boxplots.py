...
# Example usage
agent_types = ['SS', 'SS_New', 'SS_New2', 'Functional', 'Agent','Agent_FineTuned', 'HERON']
agent_names = ['SS', 'SS_New', 'SS_New2', 'High Load Follow', 'DRL Agent','Agent_FineTuned', 'MILP Solution']

dict_nppd = {'SS':[[],[]],'SS_New':[[],[]],'SS_New2':[[],[]], 'Functional':[[],[]], 'Agent':[[],[]],'Agent_FineTuned':[[],[]], 'HERON':[[],[]]}

for month in range(0,12,1):
    for agent_type in ['Agent','Agent_FineTuned']:
        if agent_type == ('SS_New' or 'SS_New2'):
            filename = f'output_month_{month}_SS.csv'
        if agent_type == 'SS':
            filename = f'output_month_{month}_SS.csv'
        elif agent_type == 'Functional':
            filename = f'output_month_{month}_functional.csv'
        elif agent_type == ('Agent' or 'Agent_FineTuned'):
...
plt.title('Boxplots of profitability')
plt.ylabel('Normalised Profit per Day / MWh')
plt.xlabel('Agent Type')
plt.boxplot(dict_list, labels = agent_names) 
#plt.show()
plt.savefig('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/Boxplot_profit.png')
...
plt.boxplot(dict_list, labels = agent_names) 
#plt.show()
plt.savefig('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/Boxplot_errors.png')