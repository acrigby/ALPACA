...
plt.title('Violin Plot of profitability')
...
#plt.show()
plt.savefig('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/Violinplot_profit_subhours.png')
...
print('Mean of MILP Load Follow is = ' + str(sum(dict_list[3])/12))
...
plt.xticks([y + 1 for y in range(len(dict_list))],labels=agent_names) 
#plt.show()
plt.savefig('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/Violinplot_errors_subhours.png')
