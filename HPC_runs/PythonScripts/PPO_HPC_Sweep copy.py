...
for j in range(1101,1102,1):
    ...
    policy = Policy.from_checkpoint('/home/rigbac/ray_results/PPO_2024-08-15_16-51-53/PPO_Reactor-v8_fe178_00004_4_train_batch_size=1024_2024-08-15_16-52-05/checkpoint_000167')
    print(model.)
    ...
    for i in range(1):
        ...
        temps_o.append(observation_o[0]+400)
        ...
        while not (terminated_o or truncated_o):
            ...
            temps_o.append(next_observation_o[0]+400)
            ...
            axs[0].plot(t1_o, temps_o, label = 'Original')
            axs[0].plot(t1, temps)
            axs[0].axhspan(398, 402, alpha=0.5, label = "Temperature Band", color = 'green')
