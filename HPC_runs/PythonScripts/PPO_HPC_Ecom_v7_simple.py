...
algo = (
    ...
    .training(train_batch_size=(320), lr_schedule = [[0,1e-4],[400000,1e-8]])
    .resources(num_cpus_per_worker=1)
    .environment(env= "ReactorEcom-v7")
    .build()
)
...
for i in range(3000):
    ...
    if i % 15 == 0:
        checkpoint_dir = algo.save(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Checkpoints/TrainedPPOEcom_new_3_1_{i}").checkpoint.path
