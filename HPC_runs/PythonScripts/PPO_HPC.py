...
algo = Algorithm.from_checkpoint('/home/rigbac/Projects/ALPACA/RunData/PPO_2024-06-11_08-14-46/PPO_Reactor-v8_fd033_00004_4_train_batch_size=1024_2024-06-11_08-15-00/checkpoint_000640')
"""
...
for i in range(10):
    ...
    if i % 1 == 0:
        ...
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FinalControlPPO2/Iteration_{i}.png")
        plt.close()

        plt.plot(rewards)
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FinalControlPPO2/Rewards.png")
        plt.close()
        # Print the final score
        print(f"FINAL SCORE: {score} - Temperature: {0}") # Print the final score
    
    if i % 50 == 0:
        checkpoint_dir = algo.save(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PaperRayTest/FinalControlPPO2/FinalControlPPO_{i}").checkpoint.path
