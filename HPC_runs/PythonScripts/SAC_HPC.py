...
plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/SAC2/original.png")
plt.close()
...
algo = (
    ...
    .training(train_batch_size=(512),lr=0.0001)
    .resources(num_cpus_per_worker=1,num_gpus=0)
    .environment(env= "Reactor-v7")
    .build()
)

#algo = Algorithm.from_checkpoint("/home/rigbac/Projects/ALPACA/HPC_runs/Output/Checkpoints/TrainedSAC_1100")
...
for i in range(3000):
    ...
    if i % 5 == 0:
        ...
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/SAC2/Iteration_{i}.png")
        plt.close()

        plt.plot(rewards)
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/SAC2/Rewards.png")
        plt.close()
        # Print the final score
        print(f"FINAL SCORE: {score} - Temperature: {0}") # Print the final score
    
    if i % 50 == 0:
        checkpoint_dir = algo.save(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Checkpoints/TrainedSAC2_{i}").checkpoint.path
