...
for i in range(0,73,1):
    ...
    csv_file = f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/HERON/output_year_HERON_45.csv"

    csv_actions = "/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/HERON/dispatch_print_730_45.csv"
    ...
    observation, info = env.reset(options={'period':i})
    ...
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/HERON/Iteration_year_{i}.png")
    plt.close()

    plt.plot(rewards)
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/HERON/Rewards.png")
    plt.close()
