...
for i in range(0,73,1):
    ...
    csv_file = f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/Functional/output_year_Funct.csv"
    ...
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/Functional/Iteration_year_{i}.png")
    plt.close()

    plt.plot(rewards)
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/Functional/Rewards.png")
    plt.close()
