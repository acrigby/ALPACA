...
for i in range(0,73,1):
    ...
    csv_file = f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/SS/output_year_SS_4.csv"
    ...
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/SS/Iteration_year_{i}.png")
    plt.close()

    plt.plot(rewards)
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestYears/SS/Rewards.png")
    plt.close()
