...
def read_csv_and_create_lists(path):
    ...
    for file in range(30,34):

        file_name = path + 'output' + str(file)+'.csv'
        ...
        with open(file_name, mode='r') as file:
            ...
            for row in reader:
                temp_value = float(row[4])  # Column 4 (index 3)
...
if __name__ == "__main__":
    ...
    for i, segment in enumerate(lists):
        ...
        try:
            ...
            plt.xlabel('Normalised Price / $/MWh')
            ...
            plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FinalPPO3/Correlation_Price_new.png")
            plt.close()
