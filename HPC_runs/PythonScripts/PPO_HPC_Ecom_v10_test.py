...
for i in range(30,41,1):
    ...
    print(f'Profit of Year is: {profit}')
    ...
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FinalPPO2/Iteration_year_new3_{i}.png")
    plt.close()

    plt.plot(rewards)
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/FinalPPO2/Rewards.png")
    plt.close()
    # Print the final score
    print(f"FINAL SCORE: {score} - Temperature: {0}") # Print the final score

if i % 50 == 0:
    checkpoint_dir = algo.save(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Checkpoints/PPOFinal4_year_{i}").checkpoint.path
