...
os.makedirs('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/SS_New2', exist_ok=True)

for m in range(0,1,1):

    os.makedirs(f'/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/SS_New2/Month_{m}', exist_ok=True)

    os.chdir('/home/rigbac/Projects/ALPACA')

    os.system('cp -a -f /home/rigbac/Projects/ALPACA/HPC_runs/FileStore_DontDisturb/. /home/rigbac/Projects/ALPACA/HPC_runs/DSFinalStore5')

    env_name = "ReactorEcom-v15"
    env = gym.make(env_name)
    ...
    for i in range(0,7,1):
        ...
        csv_file = f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/SS_New2/Month_{m}/output_month_{m}_SS.csv"
        ...
        while not (terminated or truncated):
            ...
            if 169.5 < ((observation[2]*10)+168):
                action = 2
            if 167.5 <= ((observation[2]*10)+168) <= 169.5 :
                action = 5
            if ((observation[2]*10)+168) < 167.5 :
                action = 7
        ...
        os.system('cp -a -f /scratch/rigbac/ThreadFilesFWHPT/' + str(tid) + '/dsres.mat /home/rigbac/Projects/ALPACA/HPC_runs/DSFinalStore5')
        os.system('cp -a -f /scratch/rigbac/ThreadFilesFWHPT/' + str(tid) + '/dsfinal.txt /home/rigbac/Projects/ALPACA/HPC_runs/DSFinalStore5')
        ...
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/SS_New2/Month_{m}/Iteration_year_{i}.png")
        plt.close()

        plt.plot(rewards)
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/SS_New2/Month_{m}/Rewards.png")
        plt.close()
