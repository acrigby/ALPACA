...
os.makedirs('/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/Functional', exist_ok=True)

for m in range(0,12,1):

    os.makedirs(f'/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/Functional/Month_{m}', exist_ok=True)

    os.chdir('/home/rigbac/Projects/ALPACA')

    os.system('cp -a -f /home/rigbac/Projects/ALPACA/HPC_runs/FileStore_DontDisturb/. /home/rigbac/Projects/ALPACA/HPC_runs/DSFinalStore4')
    ...
    for i in range(0,7,1):
        ...
        csv_file = f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/Functional/Month_{m}/output_month_{m}_functional.csv"
        ...
        while not (terminated or truncated):
            ...
            if 170.5 < ((observation[2]*10)+168):
                action = 1
            if 169.5 < ((observation[2]*10)+168) < 170.5 :
                if 0.8 < observation[4] < 1 :
                    action = 1
                else:
                    action = 1
            if 168.5 < ((observation[2]*10)+168) < 169.5 :
                if 0.8 < observation[4] < 1 :
                    action = 2
                else:
                    action = 4
            if 167.5 < ((observation[2]*10)+168) < 168.5 :
                if 0.8 < observation[4] < 1 :
                    action = 3
                else:
                    action = 5
            if 166.5 < ((observation[2]*10)+168) < 167.5 :
                if 0.8 < observation[4] < 1 :
                    action = 4
                else:
                    action = 6
            if 165.5 < ((observation[2]*10)+168) < 166.5 :
                if 0.8 < observation[4] < 1 :
                    action = 6
                else:
                    action = 6
            if ((observation[2]*10)+168) < 165.5 :
                action = 7
        ...
        os.system('cp -a -f /scratch/rigbac/ThreadFilesFWHPT/' + str(tid) + '/dsres.mat /home/rigbac/Projects/ALPACA/HPC_runs/DSFinalStore4')
        os.system('cp -a -f /scratch/rigbac/ThreadFilesFWHPT/' + str(tid) + '/dsfinal.txt /home/rigbac/Projects/ALPACA/HPC_runs/DSFinalStore4')
        ...
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/Functional/Month_{m}/Iteration_year_{i}.png")
        plt.close()

        plt.plot(rewards)
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/TestMonths/Functional/Month_{m}/Rewards.png")
        plt.close()
