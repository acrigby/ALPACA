...
for i in range(0,73,1):
    ...
    csv_file = f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/SSPPO/output_year_SS.csv"
    ...
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/SSPPO/Iteration_year_{i}.png")
    plt.close()

    plt.plot(rewards)
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/SSPPO/Rewards.png")
    plt.close()
