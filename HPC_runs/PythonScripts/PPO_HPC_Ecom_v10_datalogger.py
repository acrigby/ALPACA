...
for i in range(0,73,1):
    ...
    csv_file = f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/Logging2/output_year_logging.csv"
    ...
    write_list_as_row_to_csv(csv_file, observation, t - 3600 + 3600*24*i, 0)
    ...
    while not (terminated or truncated):
        ...
        if next_observation is None:
            ...
            write_list_as_row_to_csv(csv_file, next_observation, t - 3600 + 3600*24*i, float(results['penalty']))
    ...
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/Logging2/Iteration_year_{i}.png")
    plt.close()

    plt.plot(rewards)
    plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/Logging2/Rewards.png")
    plt.close()
