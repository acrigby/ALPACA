...
algo = (
    ...
    .resources(num_cpus_per_worker=1,num_gpus=0)
    .environment(env= "ReactorEcom-v4")
    .build()
)
...
for i in range(3000):
    ...
    if i % 30 == 0:
        ...
        while not (terminated or truncated):
          ...
          times.append(t)
          times.append(t+3599)
          price_list.append(5000*next_observation[-3])
          price_list.append(5000*next_observation[-3])
          score += (reward - 2000)
          t+=3600
        ...
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PPO_Ecom4/Iteration_{i}.png")
        plt.close()

        plt.plot(rewards)
        plt.savefig(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Figures/PPO_Ecom4/Rewards.png")
        plt.close()
        # Print the final score
        print(f"FINAL SCORE: {score} - Temperature: {0}") # Print the final score
    
    if i % 50 == 0:
        checkpoint_dir = algo.save(f"/home/rigbac/Projects/ALPACA/HPC_runs/Output/Checkpoints/TrainedPPOEcom4_{i}").checkpoint.path
