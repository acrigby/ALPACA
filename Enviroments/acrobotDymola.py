...
class AcrobotEnv(Env):
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        trajsize = dymola.readTrajectorySize("C:/Users/localuser/Documents/DymolaPython/DoublePendulum.mat")
        signals=dymola.readTrajectory("C:/Users/localuser/Documents/DymolaPython/DoublePendulum.mat", self.variables, trajsize)
    ...
    def step(self, a):
        ...
        ns, self.results = DymolaDyn(s_augmented, self.t, self.variables, self.results)
...
def DymolaDyn(y0 , t,  variables, results):
    ...
    dymola.ExecuteCommand('importInitial("C:/Users/localuser/Documents/DymolaPython/dsfinal.txt")')
    ...
    trajsize = dymola.readTrajectorySize("C:/Users/localuser/Documents/DymolaPython/DoublePendulum.mat")
    signals=dymola.readTrajectory("C:/Users/localuser/Documents/DymolaPython/DoublePendulum.mat", variables, trajsize)
